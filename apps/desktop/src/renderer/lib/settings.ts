...
export const SETTINGS_SECTIONS: SettingsSectionMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'wakeWord', label: 'Wake word', type: 'text', placeholder: 'vira' },
      { key: 'wakeWordThreshold', label: 'Wake-word sensitivity', type: 'number', placeholder: '0.5', description: '0 to 1. Lower hears more easily but can false-trigger; higher needs a clearer "Vira".' },
      { key: 'wakeWordPython', label: 'Wake-word Python (optional)', type: 'text', placeholder: 'C:\\Users\\you\\.vyra\\wakeword\\Scripts\\python.exe', description: 'Full path to the Python that has openwakeword installed. Leave blank to use your system Python.' },
